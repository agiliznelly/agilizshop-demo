        ...
        <div <?php if($modern_ecommerce_i == 1){echo 'class="carousel-item active"';} else{ echo 'class="carousel-item"';}?>>
          <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 slide-content ">
              <div class="carousel-caption text-center text-md-left text-sm-left px-5 px-md-3">
                ...
                <div class="home-btn text-center text-md-left text-sm-left my-4">
                  <a class="py-3 px-4" href="<?php the_permalink(); ?>"><?php echo esc_html('Shop Now','storefront-ecommerce-shop'); ?><i class="fas fa-shopping-bag ml-2"></i></a>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="services-box my-5 my-lg-0">
          <div class="row">
            <?php
              ...
              $modern_ecommerce_page_query = new WP_Query(array( 'category_name' => esc_html($modern_ecommerce_services_category ,'storefront-ecommerce-shop')));?>
  ...
  <?php if( get_theme_mod('modern_ecommerce_product_title') != '' || get_theme_mod('modern_ecommerce_product_text') != '' || get_theme_mod('modern_ecommerce_product_box_page') != ''){ ?>
    <section id="product-box" class="my-5">
      <div class="container">
        ...
        <?php
          $modern_ecommerce_page_mod =  get_theme_mod( 'modern_ecommerce_product_box_page' );
          if ( 'page-none-selected' != $modern_ecommerce_page_mod ) {
            $modern_ecommerce_product_page[] = $modern_ecommerce_page_mod;
          }

					...
					<div class="container">
						<div class="row">
							<div class="col-lg-10 col-md-9 align-self-center">
								<?php if( get_theme_mod('yoga_studio_contact_enable') != ''){ ?>
									...
									<?php if( get_theme_mod('yoga_studio_phone') != ''){ ?>
										<span class="ml-md-4"><strong><?php esc_html_e('Call Us : ','yoga-studio'); ?></strong><?php echo esc_html(get_theme_mod('yoga_studio_phone','')); ?></span>
									<?php }?>
									<?php if( get_theme_mod('yoga_studio_address') != ''){ ?>
										<span class="ml-md-4"><strong><?php esc_html_e('Address : ','yoga-studio'); ?></strong><?php echo esc_html(get_theme_mod('yoga_studio_address','')); ?></span>
									<?php }?>
								<?php } ?>
							</div>
							<div class="col-lg-2 col-md-3 align-self-center">
								<div class="links text-center text-lg-right text-md-right">
									<?php if( get_theme_mod('yoga_studio_social_enable') != ''){ ?>
										<?php if( get_theme_mod('yoga_studio_linkdin') != ''){ ?>
											<a href="<?php echo esc_url(get_theme_mod('yoga_studio_linkdin','')); ?>"><i class="fab fa-linkedin-in mr-3"></i></a>
										<?php }?>
										<?php if( get_theme_mod('yoga_studio_instagram') != ''){ ?>
											<a href="<?php echo esc_url(get_theme_mod('yoga_studio_instagram','')); ?>"><i class="fab fa-instagram mr-3"></i></a>
										<?php }?>
										<?php if( get_theme_mod('yoga_studio_facebook') != ''){ ?>
											<a href="<?php echo esc_url(get_theme_mod('yoga_studio_facebook','')); ?>"><i class="fab fa-facebook-f mr-3"></i></a>
										<?php }?>
										<?php if( get_theme_mod('yoga_studio_pintrest') != ''){ ?>
											<a href="<?php echo esc_url(get_theme_mod('yoga_studio_pintrest','')); ?>"><i class="fab fa-pinterest-p mr-3"></i></a>
										<?php }?>
										<?php if( get_theme_mod('yoga_studio_youtube') != ''){ ?>
											<a href="<?php echo esc_url(get_theme_mod('yoga_studio_youtube','')); ?>"><i class="fab fa-youtube mr-3"></i></a>
										<?php }?>
									<?php }?>
								</div>
							</div>
							...
							<div class="col-lg-3 col-md-3 col-sm-6 col-12 align-self-center">
								<div class="logo text-center text-md-left text-sm-left py-3 py-md-0">
						            ...
						            <?php endif; ?>
					              	...
					              	<?php if( get_theme_mod('yoga_studio_logo_title',true) != '' ){ ?>
						            ...
						            <?php }?>
						                ...
						                ?>
						                <?php if( get_theme_mod('yoga_studio_logo_text',true) != '' ){ ?>

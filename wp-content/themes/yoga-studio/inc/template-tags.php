...
function yoga_studio_entry_footer() {
	...
	if ( ( ( yoga_studio_categorized_blog() && $categories_list ) || $tags_list ) || get_edit_post_link() ) {
...
function yoga_studio_categorized_blog() {
	$category_count = get_transient( 'yoga_studio_categories' );
	...
	if ( false === $category_count ) {
		...
		set_transient( 'yoga_studio_categories', $category_count );
	}

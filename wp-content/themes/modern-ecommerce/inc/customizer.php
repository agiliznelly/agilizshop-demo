...
function modern_ecommerce_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_setting( 'modern_ecommerce_logo_text', array(
		'default'           => true,
		'transport'         => 'refresh',
		'sanitize_callback' => 'modern_ecommerce_sanitize_checkbox',
	) );
	$wp_customize->add_control( new Modern_Ecommerce_Toggle_Control( $wp_customize, 'modern_ecommerce_logo_text', array(
